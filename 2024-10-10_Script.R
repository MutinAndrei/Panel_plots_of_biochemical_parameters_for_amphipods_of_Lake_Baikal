...
#download data
ATP <- read.xlsx("Table S3_Raw data.xlsx", sheet = 2)
ADP <- read.xlsx("Table S3_Raw data.xlsx", sheet = 3)
AMP <- read.xlsx("Table S3_Raw data.xlsx", sheet = 4)
AEC <- read.xlsx("Table S3_Raw data.xlsx", sheet = 5)
Glucose <- read.xlsx("Table S3_Raw data.xlsx", sheet = 6)
Glycogen <- read.xlsx("Table S3_Raw data.xlsx", sheet = 7)
POD <- read.xlsx("Table S3_Raw data.xlsx", sheet = 8)
CAT <- read.xlsx("Table S3_Raw data.xlsx", sheet = 9)
GST <- read.xlsx("Table S3_Raw data.xlsx", sheet = 10)
LDH <- read.xlsx("Table S3_Raw data.xlsx", sheet = 11)
