...
f2 <- read.xlsx("Эксперимент по выживаемости 2024.xlsx", sheet="O. flavus 200 м", rows=52:70, cols=c2i("b:l"))
f5 <- read.xlsx("Эксперимент по выживаемости 2024.xlsx", sheet="O. flavus 500 м", rows=62:85, cols=c2i("b:j"))
a3 <- round(read.xlsx("Эксперимент по выживаемости 2024.xlsx", sheet="O. albinus 300 м", rows=62:83, cols=c2i("b:l")))
a5 <- read.xlsx("Эксперимент по выживаемости 2024.xlsx", sheet="O. albinus 500 м", rows=63:84, cols=c2i("b:l"))
